...
using PartSmith.PartSmithCode.Extensions;
...
/// </summary>
public abstract class PartSmithCard(int cost, CardType type, CardRarity rarity, TargetType target, bool showInCardLibrary = true) :
