...
/// <summary>效果卡:点数 4。Backstab。效果同原版 Backstab(猎人)。</summary>
[Pool(typeof(PartSmithHunterEffectCardPool))]
public class BackstabFragment : EffectCardModelBase
{
    public BackstabFragment() : base(0, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 4;

    protected override CardModel PortraitSourceCard => ModelDb.Card<Backstab>();
