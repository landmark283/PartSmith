...
/// <summary>效果卡:点数 6。Defile。效果同原版 Defile(亡灵契约师)。</summary>
[Pool(typeof(PartSmithBoneManEffectCardPool))]
public class DefileFragment : EffectCardModelBase
{
    public DefileFragment() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 6;

    protected override CardModel PortraitSourceCard => ModelDb.Card<Defile>();
