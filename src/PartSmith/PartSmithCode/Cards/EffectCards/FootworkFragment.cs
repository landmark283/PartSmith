...
/// <summary>效果卡:点数 7。Footwork。效果同原版 Footwork(猎人)。</summary>
[Pool(typeof(PartSmithHunterEffectCardPool))]
public class FootworkFragment : EffectCardModelBase
{
    public FootworkFragment() : base(0, CardType.Power, CardRarity.Uncommon, TargetType.Self)
    {
    }

    public override int PointCost => 7;

    protected override CardModel PortraitSourceCard => ModelDb.Card<Footwork>();
