...
/// <summary>效果卡:点数 6。Defy。效果同原版 Defy(亡灵契约师)。</summary>
[Pool(typeof(PartSmithBoneManEffectCardPool))]
public class DefyFragment : EffectCardModelBase
{
    public DefyFragment() : base(0, CardType.Skill, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<Defy>();
