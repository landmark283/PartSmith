...
/// <summary>效果卡:点数 11。Delay。效果同原版 Delay(亡灵契约师)。</summary>
[Pool(typeof(PartSmithBoneManEffectCardPool))]
public class DelayFragment : EffectCardModelBase
{
    public DelayFragment() : base(0, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<Delay>();
