...
/// <summary>效果卡:点数 7。Memento Mori。效果同原版 MementoMori(猎人)。</summary>
[Pool(typeof(PartSmithHunterEffectCardPool))]
public class MementoMoriFragment : EffectCardModelBase
{
    public MementoMoriFragment() : base(0, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 7;

    protected override CardModel PortraitSourceCard => ModelDb.Card<MementoMori>();
    ...
    {
        "CalculationBase" => 2m, "ExtraDamage" => 1m,
        _ => 0m,
    };
