...
/// <summary>效果卡:点数 6。Cold Snap。效果同原版 ColdSnap(机器人)。</summary>
[Pool(typeof(PartSmithRobotEffectCardPool))]
public class ColdSnapFragment : EffectCardModelBase
{
    public ColdSnapFragment() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 6;

    protected override CardModel PortraitSourceCard => ModelDb.Card<ColdSnap>();
