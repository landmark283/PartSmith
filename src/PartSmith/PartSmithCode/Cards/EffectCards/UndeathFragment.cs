...
/// <summary>效果卡:点数 5。Undeath。效果同原版 Undeath(亡灵契约师)。</summary>
[Pool(typeof(PartSmithBoneManEffectCardPool))]
public class UndeathFragment : EffectCardModelBase
{
    public UndeathFragment() : base(0, CardType.Skill, CardRarity.Rare, TargetType.Self)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<Undeath>();
