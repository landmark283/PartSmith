...
/// <summary>效果卡:点数 6。Taunt。效果同原版 Taunt。</summary>
[Pool(typeof(PartSmithEffectCardPool))]
public class TauntFragment : EffectCardModelBase
{
    public TauntFragment() : base(0, CardType.Skill, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<Taunt>();
