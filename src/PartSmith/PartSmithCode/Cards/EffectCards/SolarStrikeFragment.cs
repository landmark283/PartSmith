...
/// <summary>效果卡:点数 6。Solar Strike。效果同原版 SolarStrike(储君)。</summary>
[Pool(typeof(PartSmithWangEffectCardPool))]
public class SolarStrikeFragment : EffectCardModelBase
{
    public SolarStrikeFragment() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 6;

    protected override CardModel PortraitSourceCard => ModelDb.Card<SolarStrike>();
