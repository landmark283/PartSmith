...
/// <summary>效果卡:点数 6。Shrug It Off。效果同原版 ShrugItOff。</summary>
[Pool(typeof(PartSmithEffectCardPool))]
public class ShrugItOffFragment : EffectCardModelBase
{
    public ShrugItOffFragment() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<ShrugItOff>();
