...
/// <summary>效果卡:点数 3。Beam Cell。效果同原版 BeamCell(机器人)。</summary>
[Pool(typeof(PartSmithRobotEffectCardPool))]
public class BeamCellFragment : EffectCardModelBase
{
    public BeamCellFragment() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }

    public override int PointCost => 3;

    protected override CardModel PortraitSourceCard => ModelDb.Card<BeamCell>();
