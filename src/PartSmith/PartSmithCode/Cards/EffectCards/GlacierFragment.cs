...
/// <summary>效果卡:点数 11。Glacier。效果同原版 Glacier(机器人)。</summary>
[Pool(typeof(PartSmithRobotEffectCardPool))]
public class GlacierFragment : EffectCardModelBase
{
    public GlacierFragment() : base(0, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
    {
    }
    ...
    protected override CardModel PortraitSourceCard => ModelDb.Card<Glacier>();
